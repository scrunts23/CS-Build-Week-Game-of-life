...
def resize_terminal(rows, cols):
    """
    Re-sizes the terminal to the size of rows x columns
    :param rows: Int - The number of rows for the terminal to re-size to
    :param cols: Int - The number of columns for the terminal to re-size to
    """
...
def print_grid(rows, cols, grid, generation):
    ...
    # Compile the output string together and then print it to terminal
